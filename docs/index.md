...
| 個人、グループワーク         |<a href="/files/提案ブートキャンプ課題.pdf" target="_blank" rel="noopener noreferrer">課題</a> <br> [要件・設計マトリクス](/files/要件設計マトリックス.pptx) <br> [AWSサービスのアイコン一覧](/files/icon_lists.pptx)<br>     |
